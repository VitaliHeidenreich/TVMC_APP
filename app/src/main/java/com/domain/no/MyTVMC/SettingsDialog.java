...
public class SettingsDialog extends AppCompatDialogFragment
{
    ...
    private CheckBox cbCollisionReset;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        editConnectivity = mView.findViewById(R.id.editSerialText);
        cbCollisionReset = mView.findViewById(R.id.cbCollisionReset);
        //spinnerUebergang =  mView.findViewById(R.id.spinnerUebergang);
        ...
        mBuilder.setView(mView)
                ...
                .setPositiveButton("Okay", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        if( cbCollisionReset.isChecked() )
                        {
                            iRet = true;
                        }
                        listener.applyTexts(textToBeSended, iRet);
                    }
                });
    ...
    public interface ExampleDialogListener{
        void applyTexts(String textToBeSended, boolean boo);
    }
}
